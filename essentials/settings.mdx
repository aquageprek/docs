...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more in Mintlify's [API settings guide](https://www.mintlify.com/docs/organize/settings-api).
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type='"show" | "simple" | "hide"'>
          ...
          Learn more in Mintlify's [API settings guide](https://www.mintlify.com/docs/organize/settings-api).
        </ResponseField>
      </Expandable>
    </ResponseField>
