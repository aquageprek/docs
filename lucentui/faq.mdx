...
Visit the [Changelogs](/lucentui/changelogs) to check for new releases.
Then, go to the [Updating](/lucentui/updating) section for detailed instructions on how to update your theme using either the manual method or PTB (.paytheme).